...
@export var acceleration_force: float = 42.0
...
@export var drift_grip: float = 3.6 ## Lower grip keeps the arcade drift sliding.
...
@export_group("Drift")
@export var drift_boost_force: float = 5.5 ## Extra forward force while drifting.
