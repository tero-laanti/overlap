...
- Round-end pit stop with a three-phase flow: buy positives (currently boost pads plus timer extensions, with timer-extension cost scaling per purchase), draft 1 of 2 offered hazards, then place the drafted hazard on the track before the next round
